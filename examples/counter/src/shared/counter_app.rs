...
wrap_browser_view_delegate! {
    struct CounterBrowserViewDelegate {
        runtime_style: RuntimeStyle,
    }
    ...
    impl BrowserViewDelegate {
        fn on_popup_browser_view_created(
            ...
            // creation.
            let mut window_delegate = CounterWindowDelegate::new(
    ...
    impl BrowserProcessHandler {
        ...
        fn on_context_initialized(&self) {
            ...
            if use_views {
                ...
                let mut delegate = CounterBrowserViewDelegate::new(runtime_style);
                ...
                let mut delegate = CounterWindowDelegate::new(
